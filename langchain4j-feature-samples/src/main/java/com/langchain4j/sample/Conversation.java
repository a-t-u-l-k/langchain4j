...
import static com.langchain4j.sample.AiModels.OLLAMA_CHAT_MODEL;
...
//            .build();
    ...
    public void talkToEachOther() {
        ...
        for (int i = 0; i < 5; i++) {
            model = OLLAMA_CHAT_MODEL;//i % 2 == 0 ? OLLAMA_CHAT_MODEL : claude;
    ...
    public void anotherTry(String initialPromptText) {
        ...
        ChatLanguageModel[] models = {OLLAMA_CHAT_MODEL, OLLAMA_CHAT_MODEL};
