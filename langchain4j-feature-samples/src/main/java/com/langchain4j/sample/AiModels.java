...
//            .build();
    ...
    public static final ChatLanguageModel MISTRAL_SMALL_MODEL = MistralAiChatModel.builder()
    ...
    public static final ChatLanguageModel MISTRAL_LARGE_MODEL = MistralAiChatModel.builder()
            .apiKey(ApiKeys.MISTRAL_API_KEY)
